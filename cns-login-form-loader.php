        ...
        <div class="wrap cns-wrapper">
                ...
                <form method="post" action="options.php" id="cns-form">
                        ...
                        <fieldset>
                                ...
                                <p class="cns-copyright"><?php echo __('Made with', 'cns-login-master'); ?> <span>&hearts;</span> <?php echo __('by CNS', 'cns-login-master'); ?></p>
                                        ...
                                        <div id="cns-tabs-section" class="cns-tabs">
                                                ...
                                                <ul class="cns-tab-head">
                                                        ...
                                                        <li>
                                                                ...
                                                                <a href="#cns-tab-1" class="cns-tab-link active"> <i class="dashicons dashicons-wordpress"></i><span class="tab-label"><?php echo __('Logo', 'cns-login-master'); ?></span></a>

                                                        </li>

                                                        <li>

                                                                <a href="#cns-tab-2" class="cns-tab-link"> <i class="dashicons dashicons-media-default"></i> <span class="tab-label"><?php echo __('Body Background', 'cns-login-master'); ?></span></a>

                                                        </li>

                                                        <li>

                                                                <a href="#cns-tab-3" class="cns-tab-link"> <i class="dashicons dashicons-menu"></i> <span class="tab-label"><?php echo __('Form Container', 'cns-login-master'); ?></span></a>

                                                        </li>

                                                        <li>

                                                                <a href="#cns-tab-4" class="cns-tab-link"> <i class="dashicons dashicons-unlock"></i> <span class="tab-label"><?php echo __('Login Form', 'cns-login-master'); ?></span></a>

                                                        </li>

                                                        <li>

                                                                <a href="#cns-tab-5" class="cns-tab-link"> <i class="dashicons dashicons-info"></i> <span class="tab-label"><?php echo __('Message Box', 'cns-login-master'); ?></span></a>

                                                        </li>

                                                        <li>

                                                                <a href="#cns-tab-6" class="cns-tab-link"> <i class="dashicons dashicons-admin-links"></i> <span class="tab-label"><?php echo __('Link', 'cns-login-master'); ?></span></a>

                                                        </li>

                                                        <li>

                                                                <a href="#cns-tab-7" class="cns-tab-link"> <i class="dashicons dashicons-button"></i> <span class="tab-label"><?php echo __('Button', 'cns-login-master'); ?></span></a>
                                                        ...
                                                        <section id="cns-tab-1" class="cns-tab-body entry-content active active-content">
                                                                ...
                                                                <fieldset>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2><?php echo __('Logo', 'cns-login-master'); ?></h2>
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="logo"><?php echo __('Logo Settings', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Logo width', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Logo height', 'cns-login-master'); ?></label>
                                                        ...
                                                        <section id="cns-tab-2" class="cns-tab-body entry-content">
                                                                ...
                                                                <fieldset class="cns-background-settings">
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2> <?php echo __('Body Background Settings', 'cns-login-master'); ?></h2>
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-image"><?php echo __('Background Image', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-color"><?php echo __('Background Color', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Background Blur', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Background Repeat', 'cns-login-master'); ?></label>
                                                                                ...
                                                                                <div class="body-bg-image-repeat-wrapper">
                                                                                        ...
                                                                                        <select name="admin_login_form[bg_repeat]" class="bg-repeat">
                                                                                                ...
                                                                                                <option value="inherit" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'inherit'); ?>><?php echo __('Inherit', 'cns-login-master'); ?></option>

                                                                                                <option value="initital" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'initital'); ?>><?php echo __('Initital', 'cns-login-master'); ?></option>

                                                                                                <option value="no-repeat" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'no-repeat'); ?>><?php echo __('No-repeat', 'cns-login-master'); ?></option>

                                                                                                <option value="repeat" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'repeat'); ?>><?php echo __('Repeat', 'cns-login-master'); ?></option>

                                                                                                <option value="repeat-x" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'repeat-x'); ?>><?php echo __('Repeat-x', 'cns-login-master'); ?></option>

                                                                                                <option value="repeat-y" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'repeat-y'); ?>><?php echo __('Repeat-y', 'cns-login-master'); ?></option>

                                                                                                <option value="revert" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'revert'); ?>><?php echo __('Revert', 'cns-login-master'); ?></option>

                                                                                                <option value="round" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'round'); ?>><?php echo __('Round', 'cns-login-master'); ?></option>

                                                                                                <option value="space" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'space'); ?>><?php echo __('Space', 'cns-login-master'); ?></option>

                                                                                                <option value="unset" <?php selected(!empty($admin_login['bg_repeat']) ? $admin_login['bg_repeat'] : '', 'unset'); ?>><?php echo __('Unset', 'cns-login-master'); ?></option>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Background Size', 'cns-login-master'); ?></label>
                                                                                ...
                                                                                <div class="body-bg-image-size-wrapper">
                                                                                        ...
                                                                                        <select name="admin_login_form[bg_size]" class="bg-size">
                                                                                                ...
                                                                                                <option value="auto" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'auto'); ?>><?php echo __('Auto', 'cns-login-master'); ?></option>

                                                                                                <option value="contain" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'contain'); ?>><?php echo __('Contain', 'cns-login-master'); ?></option>

                                                                                                <option value="cover" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'cover'); ?>><?php echo __('Cover', 'cns-login-master'); ?></option>

                                                                                                <option value="inherit" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'inherit'); ?>><?php echo __('Inherit', 'cns-login-master'); ?></option>

                                                                                                <option value="initital" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'initital'); ?>><?php echo __('Initital', 'cns-login-master'); ?></option>

                                                                                                <option value="revert" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'revert'); ?>><?php echo __('Revert', 'cns-login-master'); ?></option>

                                                                                                <option value="unset" <?php selected(!empty($admin_login['bg_size']) ? $admin_login['bg_size'] : '', 'unset'); ?>><?php echo __('Unset', 'cns-login-master'); ?></option>
                                                        ...
                                                        <section id="cns-tab-3" class="cns-tab-body entry-content">
                                                                ...
                                                                <fieldset>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2> <?php echo __('Form Container Settings', 'cns-login-master'); ?></h2>

                                                                                <div class="cns-label-title">

                                                                                        <label for="background-bkur"><?php echo __('Container Width', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Margin', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-blur"><?php echo __('Padding', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-blur"><?php echo __('Alignment', 'cns-login-master'); ?></label>
                                                                                ...
                                                                                <div class="login-form-wrapper">
                                                                                        ...
                                                                                        <div class="frm-align">
                                                                                                ...
                                                                                                <label for="Left"><?php echo __('Left', 'cns-login-master'); ?></label>
                                                                                        ...
                                                                                        <div class="frm-align">
                                                                                                ...
                                                                                                <label for="Center"><?php echo __('Center', 'cns-login-master'); ?></label>
                                                                                        ...
                                                                                        <div class="frm-align">
                                                                                                ...
                                                                                                <label for="Right"><?php echo __('Right', 'cns-login-master'); ?></label>
                                                        ...
                                                        <section id="cns-tab-4" class="cns-tab-body entry-content">
                                                                ...
                                                                <fieldset>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2> <?php echo __('Login Form Settings', 'cns-login-master'); ?></h2>

                                                                                <div class="cns-label-title">

                                                                                        <label for="login-form-color"><?php echo __('Background Color', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="text-color"><?php echo __('Text Color', 'cns-login-master'); ?>Text Color</label>
                                                        ...
                                                        <section id="cns-tab-5" class="cns-tab-body entry-content">
                                                                ...
                                                                <fieldset>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2> <?php echo __('Message Box Settings', 'cns-login-master'); ?></h2>

                                                                                <div class="cns-label-title">

                                                                                        <label for="lalert-box-bg-color"><?php echo __('Background Color', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="alert-box-text-color"><?php echo __('Text Color', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="background-bkur"><?php echo __('Width', 'cns-login-master'); ?></label>
                                                        ...
                                                        <section id="cns-tab-6" class="cns-tab-body entry-content">
                                                                ...
                                                                <fieldset class="background-text-settings">
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2> <?php echo __('Link Settings', 'cns-login-master'); ?></h2>

                                                                                <div class="cns-label-title">

                                                                                        <label for="link-font-size"><?php echo __('Font Size', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="link-text-color"><?php echo __('Link Text Color', 'cns-login-master'); ?></label>
                                                        ...
                                                        <section id="cns-tab-7" class="cns-tab-body entry-content">
                                                                ...
                                                                <fieldset class="background-text-settings">
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <h2> <?php echo __('Login Button Settings', 'cns-login-master'); ?></h2>

                                                                                <div class="cns-label-title">

                                                                                        <label for="login-btn-bg-color"><?php echo __('Background Color', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="login-btn-color"><?php echo __('Color', 'cns-login-master'); ?></label>
                                                                        ...
                                                                        <div class="cns-login">
                                                                                ...
                                                                                <div class="cns-label-title">
                                                                                        ...
                                                                                        <label for="login-btn"><?php echo __('Font Size', 'cns-login-master'); ?></label>
