        ...
        <div class="wrap cns-wrapper">
                ...
                <form method="post" action="options.php" id="cns-form">
                        <fieldset>
                                ...
                                <p class="whitelabel-copyright"><?php _e('Made with', 'cns-login-master'); ?> <span>&hearts;</span> by <a href="https://whitelabelwp.io/"><?php _e('WhiteLabel', 'cns-login-master'); ?></a></p>
                        </fieldset>
                </form>
        </div>
<?php }
